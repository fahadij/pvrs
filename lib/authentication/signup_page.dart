...
class _signupscreenState extends State<signupscreen> {
    ...
    showDatePicker(
      ...
      setState(() {
        ...
        DateTime now = DateTime.now();
         years = (DateTime.now().difference(value!).inDays / 365).floor();
         print("this is the value of years in picker one :$years");
      ...
      if (value != null) {
        setState(() {
          ...
          years = (DateTime
              ...
              .inDays / 365).floor();
          final DateFormat formatter = DateFormat('yyyy-MM-dd');
          String? finaldate1 = formatter.format(DateTime_2);
          dateTextEditingController.text = finaldate1.toString();
        });
      } else {
        // Set selected date to today if value is null
        setState(() {
             ...
             PasswordStrengthChecker(
                ...
                Row(
                    ...
                    children: [
                      ...
                      const Text(
                        "I agree to the terms of service", style: TextStyle(
                        color: Colors.black,
                      ),
                      ),
                    ]),
  ...
  Future<void> insert() async {
    ...
    if (isChecked2 == true) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => otp_mail( email: emailTextEditingController.text,)),
      );
    }
    // for renter
    else {
